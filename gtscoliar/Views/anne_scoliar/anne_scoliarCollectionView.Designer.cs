namespace gtscoliar.Views.anne_scoliarCollectionView {
    partial class anne_scoliarCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "anne_scoliar Tasks";
			...
			this.anne_scoliarCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.anne_scoliarCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.anne_scoliar);
			this.gridControl.DataSource = anne_scoliarCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.anne_scoliar),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.anne_scoliarCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.anne_scoliarCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.anne_scoliarCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.anne_scoliarCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.anne_scoliarCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "anne_scoliarCollectionView";
		...
		private System.Windows.Forms.BindingSource anne_scoliarCollectionViewBindingSource;
