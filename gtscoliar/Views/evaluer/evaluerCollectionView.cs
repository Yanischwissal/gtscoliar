...
namespace gtscoliar.Views.evaluerCollectionView{
    public partial class evaluerCollectionView : XtraUserControl {
        public evaluerCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<gtscoliar.ViewModels.evaluerCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtscoliar.Database.evaluer,
