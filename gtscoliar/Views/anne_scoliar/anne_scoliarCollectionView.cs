...
namespace gtscoliar.Views.anne_scoliarCollectionView{
    public partial class anne_scoliarCollectionView : XtraUserControl {
        public anne_scoliarCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<gtscoliar.ViewModels.anne_scoliarCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtscoliar.Database.anne_scoliar,
