...
namespace gtscoliar.Views.mode_de_formationCollectionView{
    public partial class mode_de_formationCollectionView : XtraUserControl {
        public mode_de_formationCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<gtscoliar.ViewModels.mode_de_formationCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtscoliar.Database.mode_de_formation,
