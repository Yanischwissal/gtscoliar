namespace gtscoliar.Views.SpecialitéCollectionView {
    partial class SpecialitéCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Specialité Tasks";
			...
			this.specialitéCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.specialitéCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.Specialité);
			this.gridControl.DataSource = specialitéCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.Specialité),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.SpecialitéCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.SpecialitéCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.SpecialitéCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.SpecialitéCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.SpecialitéCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "SpecialitéCollectionView";
		...
		private System.Windows.Forms.BindingSource specialitéCollectionViewBindingSource;
