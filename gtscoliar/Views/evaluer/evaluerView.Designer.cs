namespace gtscoliar.Views.evaluerView {
    partial class evaluerView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "evaluer Tasks";
			// 
			...
			this.evaluerViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.evaluerViewBindingSource.DataSource = typeof(gtscoliar.Database.evaluer);
			this.dataLayoutControl1.DataSource = evaluerViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.evaluerViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerViewModel), "ResetLayout", bbiResetLayout));
		...
		private System.Windows.Forms.BindingSource evaluerViewBindingSource;
