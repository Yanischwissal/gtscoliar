...
namespace gtscoliar.Views.semasetreCollectionView{
    public partial class semasetreCollectionView : XtraUserControl {
        public semasetreCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<gtscoliar.ViewModels.semasetreCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtscoliar.Database.semasetre,
