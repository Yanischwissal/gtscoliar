namespace gtscoliar.Views.promoCollectionView {
    partial class promoCollectionView {
		...
		private void InitializeComponent() {
			...
			this.promoCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.promo);
			this.gridControl.DataSource = promoCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.promo),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.promoCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.promoCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.promoCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.promoCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.promoCollectionViewModel), "Refresh", bbiRefresh));
