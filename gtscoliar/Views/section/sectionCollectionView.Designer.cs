namespace gtscoliar.Views.sectionCollectionView {
    partial class sectionCollectionView {
		...
		private void InitializeComponent() {
			...
			this.sectionCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.section);
			this.gridControl.DataSource = sectionCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.section),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.sectionCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.sectionCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.sectionCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.sectionCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.sectionCollectionViewModel), "Refresh", bbiRefresh));
