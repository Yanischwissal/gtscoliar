namespace gtscoliar.Views.semasetreCollectionView {
    partial class semasetreCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "semasetre Tasks";
			...
			this.semasetreCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.semasetreCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.semasetre);
			this.gridControl.DataSource = semasetreCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.semasetre),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.semasetreCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.semasetreCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.semasetreCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.semasetreCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.semasetreCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "semasetreCollectionView";
		...
		private System.Windows.Forms.BindingSource semasetreCollectionViewBindingSource;
