...
namespace gtscoliar.Views.SpecialitéCollectionView{
    public partial class SpecialitéCollectionView : XtraUserControl {
        public SpecialitéCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<gtscoliar.ViewModels.SpecialitéCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as gtscoliar.Database.Specialité,
