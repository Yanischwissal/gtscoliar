namespace gtscoliar.Views.evaluerCollectionView {
    partial class evaluerCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "evaluer Tasks";
			...
			this.evaluerCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.evaluerCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.evaluer);
			this.gridControl.DataSource = evaluerCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.evaluer),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.evaluerCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.evaluerCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.evaluerCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.evaluerCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "evaluerCollectionView";
		...
		private System.Windows.Forms.BindingSource evaluerCollectionViewBindingSource;
