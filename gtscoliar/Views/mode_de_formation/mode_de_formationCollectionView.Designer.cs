namespace gtscoliar.Views.mode_de_formationCollectionView {
    partial class mode_de_formationCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "mode_de_formation Tasks";
			...
			this.mode_de_formationCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.mode_de_formationCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.mode_de_formation);
			this.gridControl.DataSource = mode_de_formationCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.mode_de_formation),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.mode_de_formationCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.mode_de_formationCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.mode_de_formationCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.mode_de_formationCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.mode_de_formationCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//mode_de_formationCollectionView
			//
            ...
            this.Name = "mode_de_formationCollectionView";
		...
		private System.Windows.Forms.BindingSource mode_de_formationCollectionViewBindingSource;
