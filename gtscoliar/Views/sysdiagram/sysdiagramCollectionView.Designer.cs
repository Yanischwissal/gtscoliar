namespace gtscoliar.Views.sysdiagramCollectionView {
    partial class sysdiagramCollectionView {
		...
		private void InitializeComponent() {
			...
			this.sysdiagramCollectionViewBindingSource.DataSource = typeof(gtscoliar.Database.sysdiagram);
			...
			this.gridView.PopulateColumns(typeof(gtscoliar.Database.sysdiagram),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(gtscoliar.ViewModels.sysdiagramCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.sysdiagramCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.sysdiagramCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(gtscoliar.ViewModels.sysdiagramCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(gtscoliar.ViewModels.sysdiagramCollectionViewModel), "Refresh", bbiRefresh));
